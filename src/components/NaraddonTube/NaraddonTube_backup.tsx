...
const NaraddonTube: React.FC<NaraddonTubeProps> = () => {
  ...
  const getYoutubeEmbedUrl = useCallback(
    (videoId: string) => {
      const params = ['autoplay=1', 'playsinline=1'];
      if (embedOrigin) {
        params.push('enablejsapi=1', `origin=${encodeURIComponent(embedOrigin)}`);
      }
        ...
        <div className="naraddon-tube-container">
          <div className="tube-header">
            ...
            <p className="tube-subtitle">
              영상으로 만나는 정책자금 활용 노하우와 안전 가이드를 만나보세요.
            </p>
                    ...
                    >
                      ...
                      <div className="thumbnail-info">
                        ...
                        <div className="mobile-expand-hint">
                          <span className="mobile-hint-text">터치해서 영상 보기</span>
                      ...
                      <div className="expanded-videos">
                        {item.videos && item.videos.length > 0 ? (
                          ...
                          <div className="video-preparing-message">
                            ...
                            <p>영상 준비 중입니다</p>
                            <span className="preparing-subtitle">곧 새로운 영상을 만나보세요</span>
                          </div>
                        )}
                      </div>
                    )}
      ...
      {showUploadModal && (
        <>
          ...
          <div className="video-modal naraddon-modal naraddon-modal--form">
            ...
            <p className="naraddon-modal__description">썸네일과 영상 링크 2개를 입력해주세요.</p>
            ...
            <form className="naraddon-modal__form" onSubmit={handleUploadSubmit}>
              ...
              <input
                ...
                placeholder="https://... (이미지 업로드 또는 URL)"
                required
              />
